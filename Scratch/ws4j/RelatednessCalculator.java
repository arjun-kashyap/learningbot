...
public abstract class RelatednessCalculator extends edu.cmu.lti.ws4j.RelatednessCalculator {
    ...
    protected abstract edu.cmu.lti.ws4j.Relatedness calcRelatedness(Concept synset1, Concept synset2 );

    public abstract List<POS[]> getPOSPairs();

    // template method
    public edu.cmu.lti.ws4j.Relatedness calcRelatednessOfSynset(Concept synset1, Concept synset2 ) {
